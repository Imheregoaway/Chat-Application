...
class AppLocalizations {
  ...
  static const _strings = <String, Map<String, String>>{
    ...
    'poweredBy': {
      'en': 'Ask anything—or add your own notes in Settings to get personalized answers.',
      'es': 'Pregunta lo que quieras o añade tus notas en Ajustes.',
      'fr': 'Posez une question ou ajoutez vos notes dans Paramètres.',
      'de': 'Fragen Sie etwas oder fügen Sie Notizen in den Einstellungen hinzu.',
      'hi': 'कुछ भी पूछें, या सेटिंग्स में अपना ज्ञान जोड़ें।',
    },
    'sourcesUsed': {
      'en': 'Used {n} knowledge source(s)',
      'es': '{n} fuente(s) de conocimiento',
      'fr': '{n} source(s) de connaissances',
      'de': '{n} Wissensquelle(n)',
      'hi': '{n} ज्ञान स्रोत',
    },
    'copied': {
